...
def calcular_preco_da_compra(kilos_de_morango: int, kilos_de_maca: int):
    ...
    #kilos_de_morango = int(input('Qual o peso dos morangos?: '))
    #kilos_de_maca = int(input('Qual o peso das maças?: '))
    desconto = 0
    ...
    valor_maca = preco_maca * kilos_de_maca
    valor_morango = preco_morango * kilos_de_morango
    ...
    if kilos_de_morango > 0:
        ...
        peso_morango_str = alinha_a_direita (str(kilos_de_morango), 3)
    ...
    if kilos_de_maca > 0:
        ...
        peso_maca_str = alinha_a_direita (str(kilos_de_maca), 3)
