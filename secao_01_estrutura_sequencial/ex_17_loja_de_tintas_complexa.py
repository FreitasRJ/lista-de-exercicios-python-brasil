...
def calcular_latas_e_preco_de_tinta():
    ...
    retorno_latas = f'Você pode comprar {lata} lata(s) de 18 litros a um custo de R$ {valor_lata}. Vão sobrar {sobra:.1f} litro(s) de tinta.'
    ...
    retorno_galao = f'Você pode comprar {galao} lata(s) de 3.6 litros a um custo de R$ {valor_galao}. Vão sobrar {sobra:.1f} litro(s) de tinta.'
    ...
    retorno_lata_galao = f'Para menor custo, você pode comprar {lata_18} lata(s) de 18 litros e {galao_completa_latas} galão(ões) de 3.6 litros a um custo de R$ {valor_mescla_lata_galao}. Vão sobrar {sobra:.1f} litro(s) de tinta.'
